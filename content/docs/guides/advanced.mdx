...
3. Add the Tinyauth labels to your service:
   ...
   <Callout type="tip">
     You can use the `tinyauth.basic.password.file` label instead of the plain
     one so as your password can remain safe in a secret file. Make sure to add
     the secret file as a volume to Tinyauth.
   </Callout>
