...
<Callout type="info">
  Using `google` or `github` as provider IDs automatically fills in required
  information (e.g., redirect URL, scopes).
</Callout>
...
| Current                             | New                                 | Values                                                      |
| ----------------------------------- | ----------------------------------- | ----------------------------------------------------------- |
| `COOKIE_SECURE` (`--cookie-secure`) | `SECURE_COOKIE` (`--secure-cookie`) | `true` or `false`                                           |
...
| ------------------ | -------------- | ------ | ----------------------------- |
| `/api/healthcheck` | `/api/healthz` | `GET`  | Check if Tinyauth is running. |
| `/api/healthcheck` | `/api/healthz` | `HEAD` | Check if Tinyauth is running. |
