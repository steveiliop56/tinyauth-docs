...
<Callout type="info">
  Tinyauth by default ships with the Traefik reverse proxy. If you are using a
  different proxy, there are available guides for [Nginx Proxy
...
To generate a user you can use the Tinyauth CLI:
