...
:::note
  ...
  Manager](/docs/guides/nginx-proxy-manager), [SWAG](/docs/guides/swag), and
  [Caddy](/docs/community/caddy).
:::
...
<Tabs>
  <TabItem label="Docker">
    ...
    :::note
    When using Docker Compose or environment variables, selecting the "format for docker" option ensures proper escaping of the bcrypt hash.
    :::
  </TabItem>
  ...
  <TabItem label="Browser">
    ...
    :::note
    When using Docker Compose or environment variables, enable the "Format for Docker" option to ensure proper escaping of the bcrypt hash.
    :::
  </TabItem>
</Tabs>
