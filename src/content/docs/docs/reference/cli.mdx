...
<Tabs>
  <TabItem label="Docker">
    ```sh
    docker run -i -t --rm ghcr.io/steveiliop56/tinyauth:v5 healthcheck
    ```
  </TabItem>
...
<Tabs>
  <TabItem label="Docker">
    ```sh
    docker run -i -t --rm ghcr.io/steveiliop56/tinyauth:v5 healthcheck http://tinyauth.example.com
    ```
  </TabItem>
  <TabItem label="Binary">
      ```sh
